...
<footer> 
   ...
   <?php if (!empty($this->options->Show) && in_array('footer', $this->options->Show)): ?>  
    <p>
    ...
    <p> &copy; <?php echo date('Y');?> <a href="<?php $this->options->siteUrl(); ?>" target="_blank"> <?php $this->options->title() ?> </a>
        ...
        <?php _e(' / <a href="http://blog.minwenlsm.pw/" target="_blank">Theme(变异版1.4)</a> by <a href="http://lixianhua.com" target="_blank">绛木子</a>'); ?>

                  ...
                  <div class="row">
                      ...
                      <section class="panel panel-info">
                       <!--  <div class="panel-body">
                          <a href="#" class="thumb pull-right m-l m-t-xs avatar">
                            <img src="http://q2.qlogo.cn/headimg_dl?dst_uin=10245388&spec=100" alt="...">
                          ...
                          <div class="clear">
                            ...
                            <a href="#" class="btn btn-xs btn-success m-t-xs">Follow</a>
								...
								<a href="http://user.qzone.qq.com/<?php $this->options->qq(); ?>" target="_blank"><img
									src="<?php $this->options->qqqm(); ?>" style="width: 100%;height: 94px;"></a>
                    ...
                    <div class="col-sm-6">                  
                      <section class="panel panel-default">
                          ...
                          <img alt="最新动态" title="最新动态" src="<?php $this->options->tt(); ?>" style="height: 158px; width: 100%">
                      ...
                      <div class="clearfix text-center m-t">
                        <div class="inline">
                         ...
                         <!--  如果要修改下面small里面的内容,请固定在12字内,否则网站布局会乱哦~ -->
                          <small class="text-muted m-b"><span class="smalltxt">本博客已稳定运行<script><!--
BirthDay=new Date("<?php $this->options->time(); ?>");//修改成你网站创建时间
today=new Date();
                  ...
                  <section class="panel panel-default">
                    ...
                    <section class="chat-list panel-body">
                      <article id="chat-id-1" class="chat-item left">
                        <a href="#" class="pull-left thumb-sm avatar"> <img <?php if ($this->options->logoUrl){ ?>src="<?php $this->options->logoUrl();?>"<?php }else{ ?>src="http://secure.gravatar.com/avatar/"<?php };?>  class="img-circle" alt="..."/></a>
                      ...
                      <article id="chat-id-2" class="chat-item right">
                        <a href="#" class="pull-right thumb-sm avatar"><img src="http://tupian.qqjay.com/tou3/2015/0728/1b9c84dfa341abb5b1f2f7ce05986cf4.jpg" class="img-circle" alt="..."></a>
                        <section class="chat-body">                      

...
<div class="main-container">
    <article class="post preview" itemscope itemtype="http://schema.org/BlogPosting">
        ...
        <?php if (!empty($this->options->PageShow) && in_array('pold', $this->options->PageShow)): ?>
        ...
        <?php if (!empty($this->options->PageShow) && in_array('poldimg', $this->options->PageShow)): ?>
         ...
         <?php endif; ?>
    <?php if (!empty($this->options->PageShow) && in_array('ptool', $this->options->PageShow)): ?>                
    <div class="post-tool">
     ...
     <?php endif; ?>
     <?php if (!empty($this->options->PageShow) && in_array('pfavatar', $this->options->PageShow)): ?>   
     <div class="post-fauthor">
      ...
      <?php endif; ?>
         <?php if (!empty($this->options->PageShow) && in_array('ptags', $this->options->PageShow)): ?>

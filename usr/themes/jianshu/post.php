...
<div class="main-container">
    ...
    <?php if (!empty($this->options->Show) && in_array('author', $this->options->Show)): ?>
    ...
    <?php endif; ?>
        ...
        <?php if (!empty($this->options->Show) && in_array('old', $this->options->Show)): ?>
        ...
        <?php if (!empty($this->options->Show) && in_array('oldimg', $this->options->Show)): ?>
        ...
        <?php endif; ?>
<?php if (!empty($this->options->Show) && in_array('tool', $this->options->Show)): ?>                
    <div class="post-tool">
    ...
    <?php endif; ?>
    <?php if (!empty($this->options->Show) && in_array('favatar', $this->options->Show)): ?>   
    <div class="post-fauthor">
          <div class="author-favatar"><img src="<?php if ($this->options->favatar): ?><?php $this->options->favatar() ?><?php else: ?><?php $this->options->themeUrl('img/avatar.png'); ?><?php endif; ?>" ></div>
          <p><?php $this->options->tips(); ?></p>
        </div> 
     <?php endif; ?>
        <?php if (!empty($this->options->Show) && in_array('tags', $this->options->Show)): ?>
